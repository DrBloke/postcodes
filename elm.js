...
var _user$project$PostcodeParser$spaces = A2(
...
var _user$project$PostcodeParser$postcodeSecond = A2(
...
var _user$project$PostcodeParser$postcodeFirst = A2(
	_elm_tools$parser$Parser$inContext,
	'first part',
	_elm_tools$parser$Parser$source(
		A2(
			...
			A2(
				...
				_user$project$PostcodeParser$spaces),
			_elm_tools$parser$Parser$end)));
var _user$project$PostcodeParser$parsePostcode = function (postcode) {
	var pcSecond = _elm_lang$core$String$toUpper(
		A2(
			_elm_lang$core$String$right,
			3,
			_elm_lang$core$String$trim(postcode)));
	var parsedSecond = A2(_elm_tools$parser$Parser$run, _user$project$PostcodeParser$postcodeSecond, pcSecond);
	var pcFirst = _elm_lang$core$String$toUpper(
		_elm_lang$core$String$trim(
			A2(
				...
				3,
				_elm_lang$core$String$trim(postcode))));
	var parsedFirst = A2(_elm_tools$parser$Parser$run, _user$project$PostcodeParser$postcodeFirst, pcFirst);
	return A3(
