...
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {route: a, history: b, locationInfo: c, postcode: d};
	});
...
var _user$project$Router$aboutPath = function (postcode) {
	return A2(_elm_lang$core$Basics_ops['++'], '/', postcode);
};
			...
			switch (_p2.ctor) {
				...
				case 'OnLocationChange':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{route: newRoute, postcode: _p4.pathname}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'LocationInfoResponse':
					var _v3 = _user$project$Main$ChangeLocation(model.postcode),
...
var _user$project$Main$init = function (location) {
	...
	return A2(
		...
		_user$project$Main$GetDataFromWeb,
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_0: _elm_lang$html$Html_Attributes$href(
								_user$project$Router$aboutPath(postcode)),
							_1: {
								ctor: '::',
								_0: _user$project$Main$onLinkClick(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$GetDataFromWeb),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
